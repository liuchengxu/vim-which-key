...
let g:which_key_use_floating_win = (exists('*nvim_open_win') || exists('*popup_create')) && get(g:, 'which_key_use_floating_win', 0)
let g:which_key_floating_relative_win = get(g:, 'which_key_floating_relative_win', 1)
